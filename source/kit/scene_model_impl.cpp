...
#include <kit/serialize_std_vector.h>
#include <fstream>
#include <algorithm>
...
void SceneModelImpl::setColor(Vector3f const & _emitColor, Vector4f const & _diffuseColor)
{
...
void SceneModelImpl::render(Matrix44f const & projectionTransform, Matrix44f const & localToCameraTransform, std::vector<Vector3f> const & lightPositions, std::vector<Vector3f> const & lightColors) const
{
