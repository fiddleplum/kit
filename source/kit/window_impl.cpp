...
void WindowImpl::handleEvent(Event const & event)
{
	GuiContainerImpl::handleEvent(event, cursorPosition, cursorPositionIsValid);
}

void WindowImpl::render(SDL_GLContext glContext) const
{
	...
	GuiContainerImpl::render(windowSize);

	SDL_GL_SwapWindow(sdlWindow);
}

void WindowImpl::setCursorPosition(Vector2i position)
{
	cursorPosition = position;
}

void WindowImpl::setCursorWithinWindow(bool state)
{
