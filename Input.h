...
//! Controllers/Joysticks plugged in will have a device starting at \a Controller0 + k, where k is from 0 to one less than the number of controllers plugged in.
class Device
{
public:
  enum
...
//! You can use the standard \a Left/Middle/Right enumerations or use \a Button0 + k, where k is from 0 to one less than the number of buttons on the mouse. X and Y are always relative to the previous cursor position.
class Mouse
{
public:
  enum
